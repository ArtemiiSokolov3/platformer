...
int main()
{
    ...
    while (1)
    {
        while (mode == 1)
        {
            ...
            txTextOut(400, 10, player.dead1.c_str());
            txSleep(100);
            txClear();
        }
        ...
        while (mode == 2)
        {
            ...
            //пасхалка 1
            txDrawText(720, 10, 800, 50, "0000");
            txDrawText(720, 60, 800, 100, "0001");
            txDrawText(720, 110, 800, 150, "0010");
            txDrawText(720, 160, 800, 200, "0011");
            txDrawText(720, 210, 800, 250, "0100");
            txDrawText(720, 260, 800, 300, "0101");
            txDrawText(720, 310, 800, 350, "0110");
            txDrawText(720, 360, 800, 400, "0111");
            txDrawText(720, 410, 800, 450, "1000");
            txDrawText(720, 460, 800, 500, "1001");
            txDrawText(720, 510, 800, 550, "1010");
            txDrawText(720, 560, 800, 600, "1011");
            //
            if (deco == 1)
            {
